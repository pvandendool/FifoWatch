...
#pragma warning disable CS0169 // field unused while keylog callback is disabled
...
#pragma warning restore CS0169
		...
		public int SslActivate()
		{
			...
			try
			{
				...
				// Keylog callback disabled — was writing TLS session keys to key_*.log files on every connect.
				// Re-enable the two lines below only when capturing traffic for Wireshark analysis.
